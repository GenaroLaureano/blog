<?php
    function getAllHtml()
    {
        ...
        $sqlSelect = 'SELECT post_id,post_categoria_id,post_titulo,post_autor,post_fecha,post_imagen,post_status,post_publish FROM posts;';
        ...
        if($resultSet->num_rows > 0){
            while($row = $resultSet->fetch_assoc()){
                ...
                $tabla .=
                "<td>
                    <a href='modificar.php?post_id=$post_id'>
                    Cambiar Publico
                    </a>
                </td>";
